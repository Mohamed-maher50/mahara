    ...
    <>
      ...
      >
        <div className="container h-full flex items-center mx-auto">
          <span className="logo text-4xl mr-5 my-3">Courses</span>
          <div className="grow flex whitespace-nowrap  items-center">
            <ul className="text-sm break-normal text-clip  hidden lg:flex ">
              <Link to={"/"}>
