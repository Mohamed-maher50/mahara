...
const Courses: React.FC = () => {
  ...
  return (
    <div className="pt-20 grid gap-y-3">
      ...
      <div className="grid lg:grid-cols-12 gap-x-4 py-5 container">
        {/* container  */}
        <motion.div
          className="col-span-9  grid gap-y-8 "
        ...
        {/* container */}
        <div className=" lg:col-span-3 place-content-center grid md:place-content-start   ">
          <CourseFeatures
            chapters={5}
            Videos={3}
